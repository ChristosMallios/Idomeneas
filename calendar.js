...
function updateRecords(value, index){
	...
	if(index == "calendarDate"){
		...
		if(lastEndBeginningDate != null)
			beginEndDate = lastEndBeginningDate;
		...
		for(i=1; i<rows.length; ++i){
			...
			if(row.className == 'category1' || row.className == 'category0'){
				...
				{
					if(value != "clear"){
						if(beginEndDate == null || d1 <= beginEndDate){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						} 
					} else if(d2 > d1) {
						if(beginEndDate == null || beginEndDate >= d1){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						}  
		...
		if(lastStartBeginningDate != null)
			beginStartDate = lastStartBeginningDate;
		...
		for(i=1; i<rows.length; ++i){
			...
			if(row.className == 'category1' || row.className == 'category0'){
				...
				{
					if(value != "clear"){
						if(beginStartDate ==null || d1 >= beginStartDate){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						}
					} else if(d2 < d1) {
						if(beginStartDate == null || beginStartDate <= d1){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						} 

...
function updateRecords(value, index){
	...
	if(index == "calendarDate"){
		if(value=="clear"){
			...
			for(i=1; i<rows.length; ++i){
				...
				if(row.className == 'category1' || row.className == 'category0'){
					var datePart1 = row.cells[filterColumn].innerHTML.split(" ");
		...
		var d2, end1 = null, end2 = null, start2 = null;
		if(value != "clear"){
			var selDay = value.split("/");
			var selectedDate = selDay[1]+"-"+selDay[0]+"-"+selDay[2];
			d2 = new Date(selectedDate);
			lastStartBeginningDate = d2;
		} else{
			d2 = lastStartBeginningDate;
		...
		for(i=1; i<rows.length; ++i){
			...
			if(row.className == 'category1' || row.className == 'category0'){
				...
				if(d2 > d1 && value != "clear")
					row.style.display = "none";
				else 
				{
					if(value != "clear"){
						if((end1 == null || d1 <= end1) && (end2 == null || d3 == null || d3 <= end2) && (start2 == null || d3 == null || d3 >= start2)){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						} 
		...
		var d2, start1 = null, start2 = null, end2 = null;
		if(value != "clear"){
			var selDay = value.split("/");
			var selectedDate = selDay[1]+"-"+selDay[0]+"-"+selDay[2];
			d2 = new Date(selectedDate);
			lastEndBeginningDate = d2;
		} else {
			d2 = lastEndBeginningDate;
		...
		for(i=1; i<rows.length; ++i){
			...
			if(row.className == 'category1' || row.className == 'category0'){
				...
				{
					if(value != "clear"){
						if((start1 == null || d1 >= start1) && (start2 == null || d3 == null || d3 >= start2) && (end2 == null || d3 == null || d3 <= end2)){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						}
		...
		var d2, start1 = null, start2 = null, end1 = null;
		if(value != "clear"){
			var selDay = value.split("/");
			var selectedDate = selDay[1]+"-"+selDay[0]+"-"+selDay[2];
			d2 = new Date(selectedDate);
			lastEndEndingDate = d2;
		} else {
			d2 = lastEndEndingDate;
		...
		for(i=1; i<rows.length; ++i){
			...
			if(row.className == 'category1' || row.className == 'category0'){
				...
				if(d2 < d3 && value != "clear")
					row.style.display = "none";
				else 
				{
					if(value != "clear"){
						if((start1 == null || d1 >= start1) && (start2 == null || d3 == null || d3 >= start2) && (end1 == null || d1 <= end1)){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						}
		...
		var d2, start1 = null, end1 = null, end2 = null;
		if(value != "clear"){
			var selDay = value.split("/");
			var selectedDate = selDay[1]+"-"+selDay[0]+"-"+selDay[2];
			d2 = new Date(selectedDate);
			lastStartEndingDate = d2;
		} else {
			d2 = lastStartEndingDate;
		...
		for(i=1; i<rows.length; ++i){
			...
			if(row.className == 'category1' || row.className == 'category0'){
				...
				{
					if(value != "clear"){
						if((start1 ==null || d1 >= start1) && (end1 == null || d1 <= end1) && (end2 == null || d3 == null || d3 <= end2)){
							lastDisplay = i;
							row.style.display = "table-row";
							rows[headerIndex].style.display = "table-row";
						}
